...
namespace FinSync.Persistence.Migrations
{
    ...
    [Migration("20260727083049_AddPremiumPayment")]
    partial class AddPremiumPayment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinSync.Domain.Entities.InsurancePlan", b =>
                {
                    ...
                    b.Property<int?>("InsuranceCompanyCompanyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InsuranceCompanyCompanyId");
            ...
            modelBuilder.Entity("FinSync.Domain.Entities.InsurancePlan", b =>
                {
                    ...
                    b.HasOne("FinSync.Domain.Entities.InsuranceCompany", null)
                        .WithMany("InsurancePlans")
                        .HasForeignKey("InsuranceCompanyCompanyId");
